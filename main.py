...
class Game:
    ...
    def new(self):
        ...
        self.draw_tiles()
        self.button_list = []
        self.button_list.append(Button(412, 550, 200, 50, "Shuffle", WHITE, BLACK))
        self.button_list.append(Button(412, 630, 200, 50, "Reset", WHITE, BLACK))
    ...
    def draw(self):
        ...
        UIElement(825, 120, "Time", 30).draw(self.screen)
        UIElement(825, 150, "%.3f" % self.elapsed_time, 30).draw(self.screen)
        UIElement(100, 120, "High Score", 30).draw(self.screen)
        UIElement(100, 150, "%.3f" % (self.high_score if self.high_score > 0 else 0), 30).draw(self.screen)
